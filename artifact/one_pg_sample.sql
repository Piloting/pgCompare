create schema pgctest_source;
create schema pgctest_target;

CREATE TABLE pgctest_source.emp (eid int generated always as identity (start with 1 increment by 1) primary key,
...
CREATE TABLE pgctest_target.emp (eid int generated always as identity (start with 1 increment by 1) primary key,
                  first_name varchar(40),
                  last_name varchar(40),
                  email varchar(100),
                  hire_dt date,
...
INSERT INTO pgctest_source.emp (first_name, last_name, email, hire_dt, age, zip, status, salary, last_login, bio) VALUES
...
INSERT INTO pgctest_target.emp (first_name, last_name, email, hire_dt, age, zip, status, salary, last_login, bio) VALUES
('Mickey', 'Mouse', 'mickey.mouse@disney.com', TO_DATE('2010-05-12', 'YYYY-MM-DD'), 35, 90210, 'ACT', 60000.00, TO_TIMESTAMP('2024-06-15 08:30:00', 'YYYY-MM-DD HH24:MI:SS'), 'Mickey is the beloved cartoon character created by Walt Disney.'),
('Donald', 'Duck', 'donald.duck@disney.com', TO_DATE('2012-03-22', 'YYYY-MM-DD'), 33, 90211, 'ACT', 55000.00, TO_TIMESTAMP('2024-06-16 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Donald is a classic Disney character known for his temper and distinctive voice.'),
('Bugs', 'Bunny', 'bugs.bunny@wb.com', TO_DATE('2011-07-19', 'YYYY-MM-DD'), 32, 90001, 'ACT', 58000.00, TO_TIMESTAMP('2024-06-17 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Bugs is the iconic character from Looney Tunes, famous for his catchphrase "Whats up, Doc?".'),
('Scooby', 'Doo', 'scooby.doo@hanna-barbera.com', TO_DATE('2009-11-25', 'YYYY-MM-DD'), 40, 90212, 'ACT', 62000.00, TO_TIMESTAMP('2024-06-18 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Scooby-Doo is the lovable Great Dane from the Hanna-Barbera animated series.'),
...
CREATE TABLE pgctest_source.location (lid int generated always as identity (start with 1 increment by 1) primary key,
...
CREATE TABLE pgctest_target.location (lid int generated always as identity (start with 1 increment by 1) primary key,
                          longitude numeric(10,6),
                          latitude numeric(10,6),
                          city varchar(100),
                          state char(2),
...
INSERT INTO pgctest_source.location (longitude, latitude, city, state, zip, location_code) VALUES
...
INSERT INTO pgctest_target.location (longitude, latitude, city, state, zip, location_code) VALUES
(-73.935242, 40.730610, 'New York', 'NY', 10001, 1234567890.123456789),
(-118.243683, 34.052235, 'Los Angeles', 'CA', 90001, 1234567890.123456789),
(-87.623177, 41.881832, 'Chicago', 'IL', 60601, 1234567890.123456789),
(-95.358421, 29.749907, 'Houston', 'TX', 77001, 1234567890.123456789),
...
(-122.419418, 37.774929, 'San Francisco', 'CA', 94101, 1234567890.123456789),
(-84.388229, 33.749001, 'Atlanta', 'GA', 30301, 108),
(-80.191788, 25.761681, '!!!!BAD!!!!', 'FL', 33101, 1234567890.123456789),
(-71.058884, 42.360081, 'Boston', 'MA', 02101, 1234567890.123456789);
